...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Tuesday July 11th 2017 2:16PM";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(hashGenesisBlock == uint256("0x00000f18f96ca349919202037b80f7635fc7a1bc5172547cd63f1b8ebf87fd73"));
        assert(genesis.hashMerkleRoot == uint256("0xc68d2ebb9973d4689afd74de43f4009a3038d347472e3b47a033a9703ae13e23"));

       vSeeds.push_back(CDNSSeedData("162.212.153.103", "162.212.153.103"));
        //vSeeds.push_back(CDNSSeedData("node.asiccoin.cf", "node.asiccoin.cf"));
        //vSeeds.push_back(CDNSSeedData("asiccoin.no-ip.org", "asiccoin.no-ip.org"));
